...
I build production systems — from AI-powered NLP models to real-time mobile apps — with a focus on performance, reliability, and measurable outcomes.
...
<img src="https://skillicons.dev/icons?i=nextjs,react,nodejs,express,python,java,pytorch,firebase,supabase,ts,docker,git&perline=6" alt="Tech stack" />
...
#### [ReDNA](https://github.com/nanfaweb/ReDNA)
NLP model for DNA sequence classification with up to **87% accuracy**.
...
#### [QuranLens](https://github.com/nanfaweb/QuranLens)
Chrome extension that detects Quran recitations on YouTube and matches **6,236 verses** with fuzzy search.

`JavaScript` `Chrome MV3` `Levenshtein`
...
#### [Nanfa-Portfolio](https://github.com/nanfaweb/Nanfa-Portfolio)
Interactive F1-themed portfolio with live racing game, project showcase, and contact form.

[`Live →`](https://nanfafolio.vercel.app/) · `HTML` `CSS` `JavaScript`

</td>
<td width="50%" valign="top">

#### [CineFAST](https://github.com/nanfaweb/CineFAST)
Android cinema booking app with Firebase auth, SQLite snacks, seat selection, and booking history.
...
| --- | --- | --- |
| **Airline Booking** | Multi-role desktop app with secure Stripe payments | Java · Supabase · Stripe |
| **Healthcare App** | Real-time doctor–patient platform with **<200ms** responses | React Native · Firebase |

[View all on portfolio →](https://nanfafolio.vercel.app/)
